import numpy as np
def GetMicrobridgeCoarse(TXLWriter, BridgeWidth, BridgeLength, BridgeEdgeRadius, PadWidth, PadLength, EtchRadius, Layer=1, FineLayerWidth=1.5, FineCoarseOverlap=0.2, FineLayerYLength=5, NumberOfPoints = 1000):
    ...
    # Ecke
    for y in np.linspace(1.*BridgeWidth/2.+FineLayerWidth-FineCoarseOverlap,FineLayerYLength-FineCoarseOverlap,2):
        PolygonPoints.append([
...
def GetMicrobridgeFine(TXLWriter, BridgeWidth, BridgeLength, BridgeEdgeRadius, PadWidth, PadLength, EtchRadius, Layer=1, FineLayerWidth=1.5, FineCoarseOverlap=0.2, FineLayerYLength=5, NumberOfPoints = 1000):
