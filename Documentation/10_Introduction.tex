\section{Introduction}
    ...
    \subsection{Technical Information}
        ...
        namespace\\
        \keyword{EMPyLib.Experiments.Processing.Ebeam.TXLWizard} in the ``EMPyLib'' package.\\
        ...
        \begin{itemize}
            \item Windows: \commandline{sys.path.append('path to the EMPyLib')}
            \item Linux: \commandline{sys.path.append('path to the EMPyLib')}
        \end{itemize}
