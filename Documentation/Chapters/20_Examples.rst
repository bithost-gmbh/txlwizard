...
The code can be found in the file :download:`Content/Example_Simple.py </Content/Example_Simple.py>`.
The resulting SVG image is shown in Figure :ref:`ExampleSimpleSVG`.
...
The code can be found in the file :download:`Content/Example_Advanced.py </Content/Example_Advanced.py>`.
