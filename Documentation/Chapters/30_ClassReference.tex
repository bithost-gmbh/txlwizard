\section{Class Reference}
    ...
    \subsection{TXLWizard.TXLWriter}
        ...
        \subsubsection{Methods}
            \paragraph{\keyword{\_\_init\_\_}}\mbox{}\\
                \textbf{Description} Constructor method \\
                \textbf{Parameters} \\
                    \textit{Keyword Arguments (optional)}
                    \begin{itemize}
                        \item \textbf{Width} \keyword{int} Width of the sample in um. Used to draw coordinate system.
                        \item \textbf{Height} \keyword{int} Height of the sample in um. Used to draw coordinate system.
                        \item \textbf{ShowCoordinateSystem} \keyword{bool} Show the coordinate system or not
                        \item \textbf{GridDistance} \keyword{int} Coordinate Sytem Grid Spacing in um.
                        \item \textbf{SubGridDistance} \keyword{int} Coordinate System Sub-Grid Spacing in um
                    \end{itemize}
